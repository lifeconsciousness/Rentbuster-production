...
function loadContent() {
  ...
  const firstTime = localStorage.getItem('firstTimeVisited') || true
  if (firstTime === true) {
    document.querySelector('.text1').classList.add('fadeIn1')
    document.querySelector('.text2').classList.add('fadeIn2')
    document.querySelector('.text3').classList.add('fadeIn3')
    document.querySelector('.logo-home-section').classList.add('fadeInLeft')
    document.querySelector('.video-wrapper').style.animation = 'videoFromRight 7.4s both'
    document.querySelector('.appearing-anim').style.animation = 'appearSmooth 8.5s forwards'
  }
